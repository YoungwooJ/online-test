          ...
          <div class="col-xl-5 col-lg-6">
            <div class="about-content-wrapper">
              <div class="section-title mb-30">
                <h3 class="mb-25 wow fadeInUp" data-wow-delay=".2s">문제 추가</h3>
                <div style="color:red;">${errorMsg}</div>
                <p class="wow fadeInUp" data-wow-delay=".3s">문제 번호와 제목을 입력하세요.</p>
              </div>
              ...
              <button class="button button-lg radius-10 wow fadeInUp" data-wow-delay=".5s" type="submit">추가</button>
              </form>
            </div>
          </div>

          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="hero-content-wrapper">
              	<!-- 로그인 전 -->
              	<c:if test="${loginTeacher eq null}">
	                <h2 class="mb-30 wow fadeInUp" data-wow-delay=".2s">선생님 로그인</h2>
                ...
                <c:if test="${loginTeacher ne null}">
	                <h2 class="mb-30 wow fadeInUp" data-wow-delay=".2s">${loginTeacher.teacherName}님 반갑습니다.</h2>
	                <p class="mb-30 wow fadeInUp" data-wow-delay=".4s">
						시험문제와 채점된 답안지 관리가 가능합니다.
	                </p>
	                <a href="${pageContext.request.contextPath}/teacher/modifyTeacherPw" class="button button-lg radius-50 wow fadeInUp" data-wow-delay=".6s">비밀번호 수정<i class="lni lni-chevron-right"></i> </a>
	                <a href="${pageContext.request.contextPath}/teacher/logout" class="button button-lg radius-50 wow fadeInUp" data-wow-delay=".6s">로그아웃<i class="lni lni-chevron-right"></i> </a>
                </c:if>
              </div>
            </div>

          ...
          <div class="col-xl-5 col-lg-6">
            <div class="about-content-wrapper">
              <div class="section-title mb-30">
                <h3 class="mb-25 wow fadeInUp" data-wow-delay=".2s">직원 목록</h3>
                <div style="color:red;">${errorMsg}</div>
                <p class="wow fadeInUp" data-wow-delay=".3s">직원 관리 페이지입니다.</p>
              </div>
              ...
              <a type="button" href="${pageContext.request.contextPath}/employee/addEmp" class="button button-lg radius-10 wow fadeInUp" data-wow-delay=".5s">직원 등록</a>            
            </div>
          </div>

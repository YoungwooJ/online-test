          ...
          <div class="col-xl-5 col-lg-6">
            <div class="about-content-wrapper">
              <div class="section-title mb-30">
                <h3 class="mb-25 wow fadeInUp" data-wow-delay=".2s">학생 목록</h3>
                <div style="color:red;">${errorMsg}</div>
                <p class="wow fadeInUp" data-wow-delay=".3s">학생 관리 페이지입니다.</p>
              </div>
			  ...
			  <form method="get" action="${pageContext.request.contextPath}/employee/student/studentList">
		  		  <input type="text" placeholder="학생 이름" name="searchWord" value="${searchWord}">
		  		  <button type="submit">검색</button>
			  </form>   
              <a type="button" href="${pageContext.request.contextPath}/employee/student/addStudent" class="button button-lg radius-10 wow fadeInUp" data-wow-delay=".5s">학생 등록</a>    
            </div>
          </div>

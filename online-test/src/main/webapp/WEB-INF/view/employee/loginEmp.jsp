            ...
            <div class="col-lg-6">
              <div class="hero-content-wrapper">
              	...
              	<c:if test="${loginEmp eq null}">
	                <h2 class="mb-30 wow fadeInUp" data-wow-delay=".2s">직원 로그인</h2>
                ...
                <c:if test="${loginEmp ne null}">
	                <h2 class="mb-30 wow fadeInUp" data-wow-delay=".2s">${loginEmp.empName}님 반갑습니다.</h2>
	                <p class="mb-30 wow fadeInUp" data-wow-delay=".4s">
						직원, 선생님, 학생 관리가 가능합니다.
	                </p>
	                <a href="${pageContext.request.contextPath}/employee/empList" class="button button-lg radius-50 wow fadeInUp" data-wow-delay=".6s">관리페이지<i class="lni lni-chevron-right"></i> </a>
	                <a href="${pageContext.request.contextPath}/employee/modifyEmpPw" class="button button-lg radius-50 wow fadeInUp" data-wow-delay=".6s">비밀번호 수정<i class="lni lni-chevron-right"></i> </a>
	                <a href="${pageContext.request.contextPath}/employee/logout" class="button button-lg radius-50 wow fadeInUp" data-wow-delay=".6s">로그아웃<i class="lni lni-chevron-right"></i> </a>
                </c:if>
              </div>
            </div>
